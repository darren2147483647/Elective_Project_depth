...
from utils import FeatureAligner
...
class unet(nn.Module):
    ...
    def preprocess(self,device,image,imgsize=592,multiple=16):
        ...
        x=x.to(device)
        return x,(h,w)
    def align_features(self,student_features,teacher_features,loss_fn=F.mse_loss):
        return self.A(student_features,teacher_features,loss_fn=loss_fn)
...
if __name__ == "__main__":
    ...
    print(f"Total parameters: {para} M") # 通道減半後1.51638 M # 31043521 -> 5994140
    gflop = calculate_gflops(model, x)
